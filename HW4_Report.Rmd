...
```{r}
coefs <- rowSums(model$coefficients[2:5] * pca_comps$rotation[,1:4]) * pca_comps$scale
...
equation_str <- paste('Crime = ', paste(c(mapply(FUN = equation, varnames, coefs, pca_comps$center), So_str), collapse = ' + '), sep = '')
equation_str
