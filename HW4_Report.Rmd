...
Table \@ref(tab:eq-pca) shows the results computed from the above equation (using regular predictors) and the predictions using predict() on the PCA transformed test set side by side. The equation is indeed correct.
